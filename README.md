...
Подключить SDK Яндекс.Игр и добавить консоль-лог, который выведет сообщение о его подключении. Для этого в файл index.html в папке билда игры дописать скрипт:
```JS
<!-- Yandex Games SDK -->
